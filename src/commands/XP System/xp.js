...
module.exports = {
    ...
    .addSubcommand(command => command
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The level you want to edit").setRequired(true).setMinValue(1).setMaxValue(100))
    ...
    .addSubcommandGroup(group => group
        ...
        .addSubcommand(command => command
            ...
            .setDescriptionLocalizations({
                ...
                "ru": "", //russian
                "pl": "", //polish
            }).setDescription("The role you want to remove").setRequired(true))
        )
        .addSubcommand(command => command
            .setName("by-level")
            ...
            .setDescriptionLocalizations({
                ...
                "ru": "", //russian
                "pl": "", //polish
            }).setDescription("The level you want to remove the reward").setRequired(true).setMinValue(1).setMaxValue(100))
        )
    ),
