...
module.exports = {
    ...
    .addSubcommand(command => command.setName("bar-track-color").setDescription("Edit the bar color of your default card image")
    .setDescriptionLocalizations({
        "de": "", //german
        "nl": "", //dutch
        "hu": "", //hungarian
        "ru": "", //russian
        "pl": "", //polish
    }).addStringOption(option => option.setName("color").setDescription("Please set the hex code of your color here").setMinLength(7).setMaxLength(7).setRequired(true)))
    .addSubcommand(command => command.setName("rank-color").setDescription("Edit the bar color of your default card image")
    .setDescriptionLocalizations({
        "de": "", //german
        "nl": "", //dutch
        "hu": "", //hungarian
    ...
    .addSubcommand(command => command.setName("level-color").setDescription("Edit the bar color of your default card image")
    .setDescriptionLocalizations({
        "de": "", //german
        "nl": "", //dutch
        "hu": "", //hungarian
