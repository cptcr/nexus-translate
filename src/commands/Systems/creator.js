...
module.exports = {
    ...
    .addSubcommand(command => command
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription('Name of the thread').setRequired(true))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Reason for creating this Thread").setRequired(false))
    )
    .addSubcommand(command => command
        .setName("ms")
        ...
        .addIntegerOption(option => option.setName("years")
        .setDescriptionLocalizations({
            "de": "", //german
            "nl": "", //dutch
            "hu": "", //hungarian
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("the amount of years").setRequired(false))
        .addIntegerOption(option => option.setName("months")
        .setDescriptionLocalizations({
            "de": "", //german
            "nl": "", //dutch
            "hu": "", //hungarian
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("the amount of months").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("the amount of weeks").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("the amount of days").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("the amount of hours").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("the amount of minutes").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("the amount of seconds").setRequired(false))
    )
    .addSubcommand(command => command
        .setName("webhook")
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Name of the webhook").setRequired(false))
        .addStringOption(option => option.setName("avatar")
        .setDescriptionLocalizations({
            "de": "", //german
            "nl": "", //dutch
            "hu": "", //hungarian
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("avatar of the webhook").setRequired(false))
    )
    .addSubcommand(command => command
        .setName("embed")
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The title of the embed").setRequired(true))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The description").setRequired(true))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The color of the embed").setRequired(true).addChoices(
        ...
        .addStringOption(option => option.setName("hyperlink-name")
        .setDescriptionLocalizations({
            "de": "", //german
            "nl": "", //dutch
            "hu": "", //hungarian
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Name of the hyperlink").setRequired(false))
        .addStringOption(option => option.setName("hyperlink-link")
        .setDescriptionLocalizations({
            "de": "", //german
            "nl": "", //dutch
            "hu": "", //hungarian
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Add a hyper link").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("add a Thumbnail").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("image url").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The channel you will send this message").setRequired(false))
    ),
