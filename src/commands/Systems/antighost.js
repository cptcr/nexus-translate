...
module.exports = {
    ...
    .addSubcommand(command => command.setName("number-reset")
    .setDescriptionLocalizations({
        "de": "", //german
        "nl": "", //dutch
        "hu": "", //hungarian
        "ru": "", //russian
        "pl": "", //polish
    }).setDescription("Reset a users ghost ping count").addUserOption(option => option.setName("user")
    .setDescriptionLocalizations({
        "de": "", //german
        "nl": "", //dutch
        "hu": "", //hungarian
        "ru": "", //russian
        "pl": "", //polish
    }).setDescription("The user you want to reset the number of ghost pings of").setRequired(true))),
