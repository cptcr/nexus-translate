...
module.exports = {
    ...
    .addSubcommand(command => command
        ...
        .addRoleOption(option => option.setName("role").setDescription("The role you want to give")
        .setDescriptionLocalizations({
            "de": "", //german
            "nl": "", //dutch
            "hu": "", //hungarian
        ...
        .addChannelOption(option => option.setName("channel").setDescription("The channel you want to send the message")
        .setDescriptionLocalizations({
            "de": "", //german
            "nl": "", //dutch
            "hu": "", //hungarian
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The label for the button").setRequired(true))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The description of the embed").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The title of the embed").setRequired(false))
        .addBooleanOption(option => option.setName("timestamp")
        .setDescriptionLocalizations({
            "de": "", //german
            "nl": "", //dutch
            "hu": "", //hungarian
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Do you want a timestamp?").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Add a Thumbnail to your reactionrole (use imgur for the picture!)").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Add a Image to your reactionrole (use imgur for the picture!)").setRequired(false))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Use a hex code for the color (example: #ffffff)").setRequired(false).setMinLength(7).setMaxLength(7))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("Add a footer to the embed").setRequired(false))
    )
    .addSubcommand(command => command
        .setName("edit")
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The message id from the reactionrole you want to edit").setRequired(true))
        ...
        .setDescriptionLocalizations({
            ...
            "ru": "", //russian
            "pl": "", //polish
        }).setDescription("The new role you want to add").setRequired(true))
    )
    .addSubcommand(command => command
        .setName("delete")
