...
module.exports = {
    ...
    .addSubcommand(command => command.setName('load').setDescription('Loads a template. Use with caution..')
    .setDescriptionLocalizations({
        "de": "", //german
        "nl": "", //dutch
        "hu": "", //hungarian
        "ru": "", //russian
        "pl": "", //polish
    }).addStringOption(option => option.setName('template-id').setDescription('Specified template will be loaded.').setRequired(true)))
    ...
    .setDescriptionLocalizations({
        ...
        "ru": "", //russian
        "pl": "", //polish
    }).setDescription('Creates a template (clone) of your server.')),
